...
public class NaoTenhoConta extends AppCompatActivity {
    ...
    public void irParaMenuPrincipal(View view){
        ...
        final SqlConnect sqlConnect = new SqlConnect();
                    ...
                    if (task.isSuccessful()) {
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            if (cpf != null && !cpf.isEmpty()) {
                                sqlConnect.mudar(inputNomeUsuario.getText().toString());
    ...
    /*public String getInputNomeUsuario() {
        String x = inputNomeUsuario.getText().toString();
        return x;
    }*/
}
